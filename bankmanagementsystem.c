...
{   int choice;
    ...
    printf("\n\n\n\t\t\t\t\xC4\xC4\xC4\xC4\xC4\xC4\xC4 WELCOME TO THE MAIN MENU \xC4\xC4\xC4\xC4\xC4\xC4\xC4");
...
int main()
{
        char pass[15],password[15] = "password";
            char h;
            printf("\tRespected Sir/Ma'am,\n\t\t\tTo login into the system you have to type the password\n\t\t\tUsing any other function key except Enter counts as character\n\t\t\tPress Enter to Continue");
            scanf("%c", &h);
        system("cls");
